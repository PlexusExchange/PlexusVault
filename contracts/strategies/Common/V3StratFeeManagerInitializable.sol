...
import {IFeeConfig} from "../../interfaces/plexus/IFeeConfig.sol";
import {IStrategyFactory} from "../../interfaces/plexus/IStrategyFactory.sol";

contract V3StratFeeManagerInitializable is
    OwnableUpgradeable,
    PausableUpgradeable
{
     ...
     * @param _commonAddresses The common addresses of the vault, unirouter, keeper, strategist, plexusFeeRecipient and plexusFeeConfig
     */
    ...
    function plexusFeeRecipient() public view returns (address) {
        return factory.plexusFeeRecipient();
    }

    /// @notice The address of the plexus fee config, set on the factory.
    function plexusFeeConfig() public view returns (IFeeConfig) {
        return IFeeConfig(factory.plexusFeeConfig());
    }
